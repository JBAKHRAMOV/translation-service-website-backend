...
public class SecurityConfiguration {
    ...
    public static final String[] AUTH_WHITELIST = {
            ...
            "/api/v1/comments/w-sec/**",
            "/api/v1/contacts/w-sec/**",
            "/api/v1/locations/w-sec/**",
            "/api/v1/messages/w-sec/**",
            "/api/v1/orders/w-sec/**",
            "/api/v1/partners/w-sec/**",
            "/api/v1/services/w-sec/**",
            "/api/v1/social-medias/w-sec/**",
            "/webjars/**",
            "/v3/api-docs/**",
            "/swagger-resources",
            "/swagger-resources/**",
